...
//     POSTCONDITION: The size of the array is increased to fit the given 
//      exponent.
//
...
//        
//
// CONSTRUCTOR, COPY CONSTRUCTOR, AND DESTRUCTOR for the polynomial class 
...
//     POSTCONDITION: The polynomial in the argument is copied into this
//     polynomial.
//
//   ~polynomial()
//     POSTCONDITION: Deletes the polynomial and frees its resources.        
// 
// MODIFICATION MEMBER FUNCTIONS for the polynomial class 
//   void assign_coef(double coefficient, unsigned int exponent) 
//     PRECONDITION: exponent > current_degree. 
...
//     polynomial. 
//     NOTE: For exponents > coef_size, the return value is always zero. 
// 
